...
namespace StandaloneSDKDemo
{
    public partial class PersonalizeMngForm : Form
    {
        ...
        private void btn_setShortKey_Click(object sender, EventArgs e)
        {
            ...
            string strAutoChangeTime = "";  //2400;2400;2400;2400;2400;2400;2400 means AutoChange = 0
            int shortkeyID = 0;
#pragma warning disable CS0219 // La variable 'defTime' está asignada pero su valor nunca se usa
            string defTime = "2400";
#pragma warning restore CS0219 // La variable 'defTime' está asignada pero su valor nunca se usa
            string timeMon = "";
            string timeTue = "";
            string timeWed = "";
            string timeThur = "";
