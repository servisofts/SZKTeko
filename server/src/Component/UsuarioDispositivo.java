...
public class UsuarioDispositivo {
    ...
    public static JSONArray getAllCodigosUsuarios(String key_dispositivo) {
        try {
            String consulta = "select get_all_codigos_usuarios_dispositivo('"+key_dispositivo+"' ) as json";
            return SPGConect.ejecutarConsultaArray(consulta);
        } catch (Exception e) {
            return null;
        }
